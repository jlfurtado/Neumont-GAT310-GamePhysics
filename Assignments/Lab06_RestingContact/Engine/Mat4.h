...
namespace Engine
{
	...
	public:
		...
		Mat4 operator*(const Mat4& right) const
		{
			...
			|2 6 10 14 |   |2 6 10 14 |
			|3 7 11 15 | * |3 7 11 15 |*/
			return Mat4(m_values[0] * right.m_values[0]  + m_values[4] * right.m_values[1]  + m_values[8] * right.m_values[2]  + m_values[12] * right.m_values[3],
						m_values[0] * right.m_values[4]  + m_values[4] * right.m_values[5]  + m_values[8] * right.m_values[6]  + m_values[12] * right.m_values[7],
						m_values[0] * right.m_values[8]  + m_values[4] * right.m_values[9]  + m_values[8] * right.m_values[10] + m_values[12] * right.m_values[11],
						m_values[0] * right.m_values[12] + m_values[4] * right.m_values[13] + m_values[8] * right.m_values[14] + m_values[12] * right.m_values[15],

						m_values[1] * right.m_values[0]  + m_values[5] * right.m_values[1]  + m_values[9] * right.m_values[2]  + m_values[13] * right.m_values[3],
						m_values[1] * right.m_values[4]  + m_values[5] * right.m_values[5]  + m_values[9] * right.m_values[6]  + m_values[13] * right.m_values[7],
						m_values[1] * right.m_values[8]  + m_values[5] * right.m_values[9]  + m_values[9] * right.m_values[10] + m_values[13] * right.m_values[11],
						m_values[1] * right.m_values[12] + m_values[5] * right.m_values[13] + m_values[9] * right.m_values[14] + m_values[13] * right.m_values[15],

						m_values[2] * right.m_values[0]  + m_values[6] * right.m_values[1]  + m_values[10] * right.m_values[2]  + m_values[14] * right.m_values[3],
						m_values[2] * right.m_values[4]  + m_values[6] * right.m_values[5]  + m_values[10] * right.m_values[6]  + m_values[14] * right.m_values[7],
						m_values[2] * right.m_values[8]  + m_values[6] * right.m_values[9]  + m_values[10] * right.m_values[10] + m_values[14] * right.m_values[11],
						m_values[2] * right.m_values[12] + m_values[6] * right.m_values[13] + m_values[10] * right.m_values[14] + m_values[14] * right.m_values[15],

						m_values[3] * right.m_values[0]  + m_values[7] * right.m_values[1]  + m_values[11] * right.m_values[2]  + m_values[15] * right.m_values[3],
						m_values[3] * right.m_values[4]  + m_values[7] * right.m_values[5]  + m_values[11] * right.m_values[6]  + m_values[15] * right.m_values[7],
						m_values[3] * right.m_values[8]  + m_values[7] * right.m_values[9]  + m_values[11] * right.m_values[10] + m_values[15] * right.m_values[11],
						m_values[3] * right.m_values[12] + m_values[7] * right.m_values[13] + m_values[11] * right.m_values[14] + m_values[15] * right.m_values[15]);
		}
		...
		Vec3 operator*(const Vec3& right) const
		{
			...
			|2 6 10 14 |   |2|
			|3 7 11 15 | * |3|*/
			return Vec3(m_values[0] * right.GetX() + m_values[4] * right.GetY() + m_values[8] * right.GetZ() + m_values[12],
						m_values[1] * right.GetX() + m_values[5] * right.GetY() + m_values[9] * right.GetZ() + m_values[13],
						m_values[2] * right.GetX() + m_values[6] * right.GetY() + m_values[10] * right.GetZ() + m_values[14]);
		}

		Vec4 operator*(const Vec4& right) const
		{
			return Vec4(m_values[0] * right.GetX() + m_values[4] * right.GetY() + m_values[8]  * right.GetZ() + m_values[12] * right.GetW(),
						m_values[1] * right.GetX() + m_values[5] * right.GetY() + m_values[9]  * right.GetZ() + m_values[13] * right.GetW(),
						m_values[2] * right.GetX() + m_values[6] * right.GetY() + m_values[10] * right.GetZ() + m_values[14] * right.GetW(),
						m_values[3] * right.GetX() + m_values[7] * right.GetY() + m_values[11] * right.GetZ() + m_values[15] * right.GetW());
		}

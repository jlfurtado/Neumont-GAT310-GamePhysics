...
int Run(int argc, char **argv)
{
	...
	WorldEditor game;
	Engine::MyWindow *window = new Engine::MyWindow(&app, &game, WorldEditor::InitializeCallback, WorldEditor::ResizeCallback, WorldEditor::MouseMoveCallback, WorldEditor::DrawCallback, WorldEditor::UpdateCallback, nullptr, WorldEditor::MouseScrollCallback);

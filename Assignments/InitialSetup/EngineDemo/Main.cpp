...
int Run(int argc, char **argv)
{
	...
	EngineDemo game;
	Engine::MyWindow *window = new Engine::MyWindow(&app, &game, EngineDemo::InitializeCallback, EngineDemo::ResizeCallback, EngineDemo::MouseMoveCallback, EngineDemo::DrawCallback, EngineDemo::UpdateCallback, EngineDemo::PhysicsCallback, EngineDemo::MouseScrollCallback);

...
namespace Engine
{
	...
	private:
		...
		// data
		static const int MAX_STRING_SIZE = 512; // Largest number of characters expected to be drawn!
		static const int STB_BUFFER_SIZE_BYTES = 512 * MAX_STRING_SIZE; // Documentation says expect 270 bytes per char to be drawn, so I rounded up to be safe TODO: investigate possible errors here, had to increase from 300 to 500 to get messages to display properly

...
bool EngineDemo::ProcessInput(float /*dt*/)
{
	...
	if (Engine::Keyboard::KeyWasPressed('K')) { spawnNow = true; }


	//if (Engine::Keyboard::KeyWasPressed('1')) { currentFractalTexID = fractalGradientTextureID; }
	//if (Engine::Keyboard::KeyWasPressed('2')) { currentFractalTexID = fractalGradientAlternateTextureID; }

...
namespace {
	...
	Engine::Mat4 m_instantaneousVelocityArrowMatrices[MAX_OBJS];
	Engine::Mat4 m_worldVelocityArrowMatrices[MAX_OBJS];
	Engine::Mat4 m_otherArrows[MAX_OBJS];
	...
	Engine::ParticleAttachment m_particleAttachments[NUM_ATTACHMENTS];
